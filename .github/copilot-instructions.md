...
1. **Start from GitHub Issues**: All work must originate from a GitHub issue. Do not start implementation without an associated issue. Link issues to pull requests for traceability.
